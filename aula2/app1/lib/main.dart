import 'package:app1/screens/multcalc.dart';
import 'package:app1/screens/divcalc.dart';
import './screens/telacalc.dart';
import './screens/calcgetx.dart';
              ...
              children: [
                DrawerHeader(
                  child: Text(
                    ...
                    ListTile(
                      title: Text('Item 3'),
                      onLongPress: () => Navigator.push(context, MaterialPageRoute(builder: (context)=>TelaMulti())),
                     ),
                    ListTile(
                      title: Text('Item 4'),
                      onLongPress: () => Navigator.push(context, MaterialPageRoute(builder: (context)=>TelaDiv())),
                    )
              ],
            ),
          ),
